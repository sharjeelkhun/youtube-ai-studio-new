...
export function SignupContent() {
    ...
    const { signUp, signInWithGoogle, verifyOtp, resendOtp, isLoading, isPreview, loading } = useAuth()
                        ...
                        <>
                            <CardContent className="space-y-4 pt-4 pb-6">
                                ...
                                <Button
                                    type="button"
                                    variant="outline"
                                    className="w-full h-11 bg-background/50 border-border/50 hover:bg-background transition-all duration-300 transform hover:scale-[1.01] hover:shadow-md hover:border-primary/30 group relative overflow-hidden"
